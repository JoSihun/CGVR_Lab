...
public class AllNoticeDto {
    ...
    public AllNoticeDto(Integer id, String title, String content, Integer hits, LocalDateTime regDate, LocalDateTime modDate, String author, Integer category1_id, Integer category2_id, Integer category3_id, Integer attachment_id) {
        this.id = id;
        this.title = title;
