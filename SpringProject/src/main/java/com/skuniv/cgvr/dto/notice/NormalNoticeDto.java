...
public class NormalNoticeDto {
    ...
    @Builder
    public NormalNoticeDto(Long id, String title, String content, Long hits, LocalDateTime regDate, LocalDateTime modDate, String author, Long category1_id, Long category2_id, Long category3_id, Long attachment_id) {
        this.id = id;
        this.title = title;
